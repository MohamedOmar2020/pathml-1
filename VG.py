...
# visualize the Cellular Neighborhoods on the tissue and overlay a collection of cells over these neighborhoods to explore their spatial distribution.
...
def draw_voronoi_scatter(spot, c, voronoi_palette=sns.color_palette('bright'), scatter_palette='voronoi', X='X:X',
                         Y='Y:Y', voronoi_hue='neighborhood10', scatter_hue='ClusterName',
                         figsize=(5, 5),
                         voronoi_kwargs={},
                         scatter_kwargs={}):
...
spot = cells2[cells2['File Name']=='reg059_A']

_ = draw_voronoi_scatter(spot,[],)


spot = cells2[cells2['File Name']=='reg021_A']
sizes = draw_voronoi_scatter(spot,[],voronoi_kwargs={'size_max':3000})

spot = cells2[cells2['File Name']=='reg038_A']
cd4s = spot[spot['CD4+']==1]
_ = draw_voronoi_scatter(spot,cd4s)